...
export const registerPersonalTools = (): void => {
  ...
  server.addTool({
    ...
    description: "Get detail watchlist berdasarkan ID",
    parameters: watchlistIdSchema,
    annotations: {
      openWorldHint: true,
      readOnlyHint: true,
      idempotentHint: true,
    ...
    execute: async (args, context) => await watchlistDetail(args, context),
  });

  server.addTool({
    name: "trade-summary-chart",
    description: "Get trade summary chart untuk analisis performa trading",
    parameters: tradeSummaryChartSchema,
    annotations: {
      openWorldHint: true,
      readOnlyHint: true,
      idempotentHint: true,
      title: "Trade Summary Chart",
    },
    execute: async (args, context) => await tradeSummaryChart(args, context),
  });
};
